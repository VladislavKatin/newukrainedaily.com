...
function buildOpenAiPrompt(input: RewriteInput) {
  return [
    ...
    "- key_points 3-6 items, sharp and specific enough to stand alone in a visual summary box",
    ...
    "- Write so the article can support visual summary blocks, not just plain paragraphs.",
