...
function buildOpenAiPrompt(input: RewriteInput) {
  return [
    ...
    "Avoid machine-style filler, 'As an AI', 'In conclusion', 'it is worth noting', 'moreover', 'this development highlights', and similar stock phrases.",
    ...
    "- End with a clean forward-looking line, not a generic conclusion.",
