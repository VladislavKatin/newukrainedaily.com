...
function buildOpenAiPrompt(input: RewriteInput) {
  return [
    ...
    "- image_prompt must be 1-2 sentences, based on lead and body facts, realistic editorial illustration, not documentary photo, no text on image, safe, 16:9, muted colors, high detail",
    "",
